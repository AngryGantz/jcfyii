...
<div class="subnav">
    <div class="navbar navbar-inner">    
        <ul class="nav nav-pills">
            ...
            <li><?php echo CHtml::link(UserModule::t('Update User'), array('update', 'id' => $model->id)); ?></li>
            <li><?php echo CHtml::linkButton(UserModule::t('Delete User'), array('submit' => array('delete', 'id' => $model->id), 'confirm' => UserModule::t('Are you sure to delete this item?'))); ?></li>
