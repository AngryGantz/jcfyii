...
class SWFUpload extends CWidget
{
	...
	public $debug            =false;    
    public $fileSizeLimit    = 1;  // file size limit 5MB
    public $fileTypes        = '*.jpg;*.jpeg;*.gif;*.png'; // uploaded file types
    public $buttonText       = 'Загрузить фото  ';
    public $idmodel;
    public $namePhoto;
	/**
	 * callbackJS是一个js函数
	...
	public function init()
	{
	    ...
	    {
	        throw new Exception('debug фигня какая-то (false/true)');
	    }
	    ...
	    $this->postParams['fileQuenueLimit'] = $this->fileQuenueLimit;
            $this->postParams['idmodel'] = $this->idmodel;
           $this->postParams['namePhoto'] = $this->namePhoto;
